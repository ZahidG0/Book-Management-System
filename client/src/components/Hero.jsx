...
const Hero = () => {
    const { updateFilters, books, filters } = useBookContext();
    ...
    return (
        <div className="bg-gray-900 min-h-[300px] relative overflow-hidden">
            <div className="container mx-auto px-4 py-15 flex flex-col lg:flex-row flex-wrap items-center justify-between">
