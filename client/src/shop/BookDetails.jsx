...
const BookDetails = () => {
    const { id } = useParams();
    const { currentBook, loading, error, fetchBookDetails, setCurrentBook } = useBookContext();
    ...
    }, [id, fetchBookDetails, setCurrentBook]);
            ...
            <div className="max-w-5xl grid grid-cols-1 md:grid-cols-2 gap-12">
                ...
                <div className="space-y-6">
                    ...
                    <div className="flex space-x-4 pt-6">
                        <button 
                            onClick={() => addToCart({ id: currentBook._id, title: currentBook.title, authorName: currentBook.author, price: currentBook.price, imageURL: currentBook.imageUrl })}
                        ...
                        <a
                            href={currentBook.bookUrl || '#'} target='_blank' rel='noopener noreferrer'
                            className="px-6 py-3 border border-gray-300 rounded-lg text-gray-700 hover:bg-gray-50 transition-colors"
                        >
                           Want To Read...
                        </a>
